          ...
          <v-col cols="12">
            ...
            <v-card class="d-flex" tile width="100%" outlined height="100%" min-height="80">
              <v-col cols="8" justify-center align-center>
                  {{ product.productName }}<br /><v-btn color="error" outlined @click="deleteItem(product)">ลบ</v-btn>
              </v-col>
              <v-col cols="4" justify-center align-center>
                {{ product.productPrice | currency }}<br/><v-btn color="info"  text style="cursor: default">x {{ product.quantityPerUnit }}</v-btn>
              </v-col></v-card>
            </v-row>
          </v-col>
        </v-card>
